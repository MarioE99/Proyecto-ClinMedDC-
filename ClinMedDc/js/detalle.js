...
function addRowDT(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        tabla.fnAddData([
            data[i].IdDetalle,
            data[i].IdFactura,
            data[i].PrecioUnidad = formatToCurrency(data[i].Total),
...
function sendDataAjax() {
    $.ajax({
        type: "POST",
        url: "GestionarDetalleFactura.aspx/ListarDetalle",
        data: {},
...
function updateDataAjax() {
    ...
    $.ajax({
        type: "POST",
        url: "GestionarDetalleFactura.aspx/Actualizar",
        data: obj,
        dataType: "json",
        contentType: 'application/json; charset=utf-8',
        error: function (xhr, ajaxOptions, thrownError) {
...
function deleteDataAjax(data) {
    ...
    $.ajax({
        type: "POST",
        url: "GestionarDetalleFactura.aspx/EliminarDatosDetalle",
        data: obj,
        dataType: "json",
        contentType: 'application/json; charset=utf-8',
        error: function (xhr, ajaxOptions, thrownError) {
