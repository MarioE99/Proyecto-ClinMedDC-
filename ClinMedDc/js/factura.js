...
function addRowDT(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        tabla.fnAddData([
            ...
            data[i].Fecha = convertToJavaScriptDate(data[i].Fecha),
            data[i].Total = formatToCurrency(data[i].Total),
...
function sendDataAjax() {
    $.ajax({
        type: "POST",
        url: "GestionarFactura.aspx/ListarFactura",
        data: {},
...
function updateDataAjax() {
    ...
    $.ajax({
        type: "POST",
        url: "GestionarFactura.aspx/Actualizar",
        data: obj,
        dataType: "json",
        contentType: 'application/json; charset=utf-8',
        error: function (xhr, ajaxOptions, thrownError) {
...
function deleteDataAjax(data) {
    ...
    $.ajax({
        type: "POST",
        url: "GestionarFactura.aspx/EliminarDatosFactura",
        data: obj,
        dataType: "json",
        contentType: 'application/json; charset=utf-8',
        error: function (xhr, ajaxOptions, thrownError) {
